	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http, CustomOAuth2UserService customOAuth2UserService) throws Exception {
		...
		http	// 로그인/로그아웃 설정
				...
				.authorizeHttpRequests(authorizeRequests -> authorizeRequests
						...
						.requestMatchers("/admin/**", "/admin/item/create.do/**", "/admin/item/edit.do/**").hasRole("ADMIN")
						.requestMatchers("/api/track/**").hasAnyRole("USER", "ADMIN")
						.requestMatchers("/mail/**").permitAll()
						.requestMatchers("/files/**").permitAll()
						.requestMatchers("/item/**", "/item/list.do", "/item/detail/**").permitAll()
						...
						.requestMatchers("/cart/cartDetail").hasAnyRole("USER", "ADMIN")
